...
class ES8311 : public audio_dac::AudioDac, public Component, public i2c::I2CDevice {
 ...
 protected:
  ...
  bool force_master_{false};     // true = set i2s mode as master
